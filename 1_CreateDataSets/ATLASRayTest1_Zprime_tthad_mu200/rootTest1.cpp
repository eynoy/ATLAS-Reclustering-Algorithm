...
void draw_info_topoclusters(std::string& data_prefix);
void draw_info_jets(std::string& data_prefix);

TChain in_chain("tree");
int rootTest1() {
    //in_chain.Add("TestDataATLAS/user.mmazza.23179734.STREAM_TREE._*.root");
    in_chain.Add("_Zprime_tthad_mu200_*.root");
